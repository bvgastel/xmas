...
TEST_F(XMAS_LONG_QUEUE_10, NUSMV_COUNTER_FORWARD) {
...
TEST_F(XMAS_LONG_QUEUE_15, NUSMV_COUNTER_FORWARD) {
  attach(&src.o, SymbolicPacket({NAMED_ENUM("first", "a")}));
...
TEST_F(XMAS_LONG_QUEUE_20, NUSMV_COUNTER_FORWARD) {
  attach(&src.o, SymbolicPacket({NAMED_ENUM("first", "a")}));
...
TEST_F(XMAS_LONG_QUEUE_25, NUSMV_COUNTER_FORWARD) {
  attach(&src.o, SymbolicPacket({NAMED_ENUM("first", "a")}));
