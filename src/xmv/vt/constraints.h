...
{
    ConstraintFunctionExtension<ConstraintPacket (const ConstraintPacket&, const ConstraintPacket&)> *ext
            = getComponentInfo<ConstraintFunctionExtension<ConstraintPacket (const ConstraintPacket&, const ConstraintPacket&)>>(c);
    ext->function = f;
}
