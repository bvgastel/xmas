...
TEST_F(XMAS_TWOAGENTS_T2_B2, REACHABLE) {
...
TEST_F(XMAS_TWOAGENTS_T3_B2, REACHABLE) {
  checkAll("bfs foward", bfs_forward_checker);
  // checkAll("dfs forward", dfs_forward_checker);
  // checkAll("bfs backward", bfs_backward_checker);
  // checkAll("dfs backward", dfs_backward_checker);
...
TEST_F(XMAS_TWOAGENTS_T4_B2, REACHABLE) {
  checkAll("bfs foward", bfs_forward_checker);
  // checkAll("dfs forward", dfs_forward_checker);
  // checkAll("bfs backward", bfs_backward_checker);
  // checkAll("dfs backward", dfs_backward_checker);
...
TEST_F(XMAS_TWOAGENTS_T6_B2, REACHABLE) {
  checkAll("bfs foward", bfs_forward_checker);
  // checkAll("dfs forward", dfs_forward_checker);
  // checkAll("bfs backward", bfs_backward_checker);
  // checkAll("dfs backward", dfs_backward_checker);
...
TEST_F(XMAS_TWOAGENTS_T2_B3, REACHABLE) {
  checkAll("bfs foward", bfs_forward_checker);
  // checkAll("dfs forward", dfs_forward_checker);
  // checkAll("bfs backward", bfs_backward_checker);
  // checkAll("dfs backward", dfs_backward_checker);
