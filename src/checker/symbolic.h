...
public:
    ...
    virtual void printOldCSyntax(std::ostream& out, std::map<String, int>& enumMap, const bitpowder::lib::String& key) const = 0;
};
...
public:
    ...
    void printOldCSyntax(std::ostream& out, std::map<String, int>& enumMap) const;
};
