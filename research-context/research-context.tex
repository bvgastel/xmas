...
\begin{abstract}
	...
	what these benefits are and who they benefit.
	
This article answers questions:
\begin{itemize}
	\item What problem area is the research subject?
	\item What is our contribution to the solution?
	\item Why is the research area relevant? (academically or socially). The context.
	\item What is the state of the art: what research is currently being done in the problem area?
\end{itemize}
