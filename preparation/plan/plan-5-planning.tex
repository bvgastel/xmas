...
\item \underline{\textbf{Constructie (7 iteraties)}}
	...
	\item Iteratie 0
		...
		\item Requirements uit de onderzoekscontext
		\item documentatie en scriptieverslag aanpassen
		\end{itemize}
		\paragraph{Artefacten}
		 Specifieke requirements uit de onderzoekscontext, documentatie en scriptieverslag.
	\item Iteratie 1
		\begin{itemize}
