...
\begin{center}
	...
	1	& \multicolumn{2}{c|}{\sf\emph{\large vertraging in het project of de oplevering}}
		\\\hline
		& Stakeholders niet beschikbaar wanneer dat gewenst is \aanp1{(gerealiseerd risico)}.
		& skype(1),email(2),contact momenten(1a), \aanp1{aannames doen}
		\\\hline
...
\begin{center}
	...
	1 & \begin{aanpassing1}Gepland overleg via skype, minstens 1x per iteratie\end{aanpassing1}
