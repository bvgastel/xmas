...
%\end{figure}
	...
	{\tiny%%%%%%%%%%%%%%%%%%%%%%%%%%
	    ...
	    and design tool. Determine how the verification tools should communicate with
	    each other (if necessary) and how the results of the verification tools will be
	    presented to the design tool. Investigate how the integration of verification
	    tools and design tool can be made extensible to allow easy integration of future
	    verification tools.
