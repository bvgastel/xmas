...
\begin{figure}[ht]
	...
	\begin{description}
	    ...
	    op starten zoals XP.
	    \item[Hybride (AUP - DAD)] Een hybride aanpak met cherry picking van  methoden en technieken lijkt het
...
%%http://www.ambysoft.com/unifiedprocess/agileUP.html
	\begin{enumerate}
		...
		\item Environement
	\end{enumerate}
\item DAD (Disciplined Agile Delivery) is de verderzetting van AUP door Scott Ambler, het is een raamwerk dat naar de noden aangepast kan worden en voorziet in het beste van bestaande methoden. %%Bij DAD staat risico-waarde prioriteit centraal,   architectuur centraal In DAD is er geen ellaboratie fase, deze behoort tot de constructie fase en zit in de eerste iteraties. 
%%https://disciplinedagiledelivery.wordpress.com/category/dad-discussions/inception-phase/
