...
\begin{frame}
 \begin{tikzpicture}
	...
	iteration/.style={rectangle,draw=black!50,fill=green!30,anchor=west,thick,inner sep=0pt,minimum height=4mm, minimum width=6mm},
	...
	planiter/.style={rectangle,draw=black!50,fill=yellow!70!black,anchor=west,thick,inner sep=0pt,minimum height=4mm, minimum width=12mm},
	domainiter/.style={rectangle,draw=black!50,fill=green!30!yellow,anchor=west,thick,inner sep=0pt,minimum height=4mm, minimum width=8mm}]
%%	[fill=green!70!blue,every path/.style={draw}]
	...
	\path (0,0);
	\node (planning) at (0.5, \y-2) [planiter] {};
	\node [above=3mm of planning.north west,anchor=west] {Planning};
	\node (domain) at (1.8, \y-2) [domainiter] {};
	\node [below=3mm of domain.south west,anchor=west] {Domain};
	\node (arch) at (2.4, \y-2) [iteration] {};
	\node [above=3mm of arch.north west,anchor=west] {Arch};
	\node (setup) at (3.2, \y-2) [iteration] {};
	\node [above=3mm of setup.north west,anchor=west] {Setup};
	\node (iterA) at (4.4, \y-2) [iteration] {1};
	\node [above=3mm of iterA.north west,anchor=west] {Build iterations};
	\node (iterB) at (5.0, \y-2) [iteration] {2};
	\node (iterC) at (5.6, \y-2) [iteration] {3};
	\node (iterD) at (6.2, \y-2) [iteration] {4};
	\node (transition) at (7.0,\y-2) [orgiter] {}; 
