...
\title{\color{blue}Research context for the xmas designer}
...
design. It is important that designers can make use of such advanced tools
without any knowledge. This can be realized by a designer-friendly tool that
provide easy access to formal verification tools.
This document illustrates why formal verification can play a crucial role
