...
\begin{abstract}
	...
	\noindent{} This system documentation bla bla bla... (replace me).
...
\input{1-sd-changes-data-model}% include forces page break. Input does not.
%\input{2-sd-flattening}
\include{3-sd-xmd}
\include{4-sd-feedback}
\include{5-sd-file-format}
\include{6-sd-stories.tex}
