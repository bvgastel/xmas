...
communication is not as simple. In summary, \w{qt}, \w{gtkmm} and \w{WxWdiget} all suffice
without modification. For \w{fltk} we need to use one of the available cross
