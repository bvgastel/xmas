\section{Final summary of applicable tool kits}
...
\w{qt} is a complete development environment based on an extension of C++. It
...
Main characteristic of \w{qt} is that it uses a pre-compiler called
...
as free software and with a commercial license. The tool kit \w{qt} supports
the observer pattern with signals and slots. 

\paragraph{Why to choose \w{qt}?} Because it is cross platform. It is well
...
widely appreciated.  Finally, \w{qt} has an active community and very clear
...
The tool kit \w{gtkmm} supports the observer pattern using signals.

\paragraph{Why choose \w{gtkmm}?} Because it is cross platform. It is well
known and used in many applications. Because \w{gtkmm} is C++ even if it is a
