...
\begin{abstract}
	...
	\noindent{} This document reflects a domain analysis for user interface tools. It
	...
	\noindent{} It describes the user interface toolkits found, the search
...
\include{uitoolkit-A2-information}
