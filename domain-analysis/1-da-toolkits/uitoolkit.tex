...
\appendix
\include{uitoolkit-A1-phase-3-final-selection}
\include{uitoolkit-A2-final-summary}
\include{uitoolkit-A3-phase-2-main-selection}
\include{uitoolkit-A4-requirements}
\include{uitoolkit-A5-phase-0-impact}
\include{uitoolkit-A6-phase-1-discard}
