...
\include{uitoolkit-1-approach}
\include{uitoolkit-2-selection}
\include{uitoolkit-3-recommendation}

\appendix
\include{uitoolkit-A6-phase-3-listing}
\include{uitoolkit-A5-phase-3-final-selection}
\include{uitoolkit-A4-phase-2-main-selection}
\include{uitoolkit-A1-requirements}
\include{uitoolkit-A2-phase-0-impact}
\include{uitoolkit-A3-phase-1-discard}
\include{uitoolkit-A7-phase-2-listing}
