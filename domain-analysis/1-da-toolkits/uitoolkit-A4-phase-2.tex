...
\w{cegui} is a small community of developers specifically aimed at gaming, not graphical
user interface.

\w{Gled} is a framework that stems from scientific work and features the easy
distribution of nodes across threads, processes and machines.  See
\cite{greed:gled} for a discussion of the scientific goals of the \w{Greed}
project.
