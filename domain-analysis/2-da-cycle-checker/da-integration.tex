...
modern chip architecture to search for techniques that allow them to better cope
...
uses this knowledge to infer that it has to call the overloaded visit method that takes a pointer
...
right-hand side of the equation. Substitution of the right-hand side occurrence of the signal
then leads to an infinite recursion.
