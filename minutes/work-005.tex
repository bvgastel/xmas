...
\begin{description}
	...
	\item[Licenties] De code van Bernard in de subdirectory \w{lib} heeft programmatuur
	van \w{bitpowder} dat Bernard heeft geschreven, maar waarin staat ``all rights reserved''.
	Ik heb dit al eerder met Bernard afgestemd en kreeg het antwoord dat het nog op
	zijn \w{todo} stond om de licentie naar free software om te zetten. \textit{Voordat we deze
